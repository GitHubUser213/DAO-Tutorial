...
const Banner = () => {
  ...
  return (
    <div className="p-8">
      ...
      <p>
        Current DAO Balance: <strong>{balance} BNB</strong> <br />
        Your contributions:{' '}
        <span>
          <strong>{mybalance} BNB</strong>
      ...
      <p>
        {isStakeholder
          ...
          : 'Hey, when you contribute upto 1 BNB you become a stakeholder 😎'}
      </p>
